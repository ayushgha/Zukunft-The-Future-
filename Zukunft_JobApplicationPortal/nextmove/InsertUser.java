...
public class InsertUser {
	...
	public void insertTable(String Lastname,String userName,String Password) throws Exception {
		MAIN obj = new MAIN();
		try {
			Connection connection = obj.getConnection();
			String query = "INSERT INTO applicant(Lastname,Username,Password) VALUES(?,?,?,?)";
			...
			System.out.println(e);
                ...
                System.out.println(Lastname+userName+Password);}
	}
