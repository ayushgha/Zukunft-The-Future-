...
public class ExtractKeywords {
	...
	ExtractKeywords(nextmove.Tokenise tokens){
		getName(tokens);
		getPointer(tokens);
	}
	
	public void getName(nextmove.Tokenise tokens) {
		int flag = 0;
	...
	public void getPointer(nextmove.Tokenise tokens) {
		int flag = 0;
	...
	public void getSkillSet(nextmove.Tokenise tokens) {
		int flag = 0;
